        ...
        <div class="container-fluid my-2 mx-4">
            ...
            <div class="collapse navbar-collapse" id="navbarText">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0 mx-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#"> <b>Blogs</b> </a>
                    </li>
                </ul>
                @guest
                    <span class="navbar-text">
                        <div class="">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor"
                                class="bi bi-moon-stars mx-2" viewBox="0 0 16 16">
                                <path
            ...
            <div class="row">
                <div class="col-sm-12 col-md-6">
                    ...
                    <div class="mx-3">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" class="mx-2" width="20" height="20"
                            fill="currentColor" class="bi bi-linkedin" viewBox="0 0 16 16">
                            <path
                                d="M0 1.146C0 .513.526 0 1.175 0h13.65C15.474 0 16 .513 16 1.146v13.708c0 .633-.526 1.146-1.175 1.146H1.175C.526 16 0 15.487 0 14.854zm4.943 12.248V6.169H2.542v7.225zm-1.2-8.212c.837 0 1.358-.554 1.358-1.248-.015-.709-.52-1.248-1.342-1.248S2.4 3.226 2.4 3.934c0 .694.521 1.248 1.327 1.248zm4.908 8.212V9.359c0-.216.016-.432.08-.586.173-.431.568-.878 1.232-.878.869 0 1.216.662 1.216 1.634v3.865h2.401V9.25c0-2.22-1.184-3.252-2.764-3.252-1.274 0-1.845.7-2.165 1.193v.025h-.016l.016-.025V6.169h-2.4c.03.678 0 7.225 0 7.225z" />
                        </svg>
                        <svg xmlns="http://www.w3.org/2000/svg" class="mx-1" width="20" height="20"
                    ...
                    <div class="">
                        <ul class="nav">
                            <li class="nav-item">
                                <a class="nav-link text-black active" aria-current="page" href="#">
                                    <h6>Home</h6>
                                </a>
                            </li>
                            <li class="nav-item">
            ...
            <div class="mx-4 pt-2 pb-4">
                <div class="row">
                    <div class="col-sm-12 col-lg-6">
                        <h5>Inspirative text</h5>
                        <p class="text-sm">Recover Together, Recover Stronger</p>
                    </div>
                    <div class="col-sm-12 col-lg-6">
                        <div class="text-end" style="margin-right: 10px;">
                            <p class="text-sm my-4">©2024 NameWeb. All rights reserved</p>
                        </div>
                    </div>
                </div>
            </div>
